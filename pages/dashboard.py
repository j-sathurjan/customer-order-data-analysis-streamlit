...
def data_filtering():
    try:
        ...
        return st.error("error on filtering the data!")
...
def dashboard_data_visualization():
    try:
        ...
        return st.error("error on filtering the data required to draw chart")
...
def dashboard_key_metrics_display():
    try:
        ...
        return st.error("error on filter the metrics data")